...
import { Section, Pagination, ErrorOr } from "../models";
...
const Sections = () => {
  ...
  const [pagination, setPagination] = useState<Pagination<Section> | undefined>(
    undefined
  );
  ...
  const fetchData = async () => {
    await callEndpoint<Pagination<Section>>(
      getService(
